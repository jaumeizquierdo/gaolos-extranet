            ...
            columns: {
                identifier: function() {
                    ...
                    $td.each(function() {
                        ...
                        var input = '<div class="form-group"><input class="tabledit-input tabledit-identifier" type="hidden" name="' + settings.columns.identifier[1] + '" value="' + $(this).text() + '" disabled></div>';
