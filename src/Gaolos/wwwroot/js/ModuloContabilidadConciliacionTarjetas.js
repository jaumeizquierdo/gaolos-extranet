...
function reloadmovimientos(ID_Cue, ID_Pag) {
    ...
    var num = document.getElementById("reg-tar").value;
    ...
    $.ajax(
        {
            type: "GET",
            url: "/modulo-contabilidad/conciliacion/tarjetas/movimientos",
            data: { ID_Cue: ID_Cue, pag: ID_Pag, Clas: Clas, buscar: buscar_mov, Imp: importe_mov, Fe_In: Fe_In, Fe_Fi: Fe_Fi, num: num },
...
function reloadfracciones(ID_Pag) {
    ...
    $.ajax(
        {
            type: "GET",
            url: "/modulo-contabilidad/conciliacion/tarjetas/fracciones",
...
$(document.body).on('click', '.vis-fra', function () {
    ...
    $.ajax(
        {
            type: "GET",
            url: "/modulo-contabilidad/conciliacion/tarjetas/fraccion",
            data: { ID_Fra: ID_Fra },
            contentType: "application/json;charset=utf-8",
            cache: false,
            datatype: "json",
...
$(document.body).on('click', '.conciliar', function () {
    ...
    $.ajax(
        {
            type: "GET",
            url: "/modulo-contabilidad/conciliacion/tarjetas/conciliacion",
...
$(document.body).on('click', '.descargar-doc', function () {
    ...
    window.open("/modulo-contabilidad/conciliacion/tarjetas/fracciondocumento?ID_Fra=" + strid[1]);
