...
$(function () {
    ...
    $("#Agente").autocomplete({
        ...
        source: function (request, responsefunc) {
            $.ajax({
                type: "POST",
                url: "/modulo-clientes/consultas/resumen-empresas-relacionadas/buscar-agente",
...
$(function () {
    ...
    $("#emprelvin").autocomplete({
        ...
        source: function (request, responsefunc) {
            $.ajax({
                type: "POST",
                url: "/modulo-clientes/consultas/resumen-empresas-relacionadas/buscar-empresa-relacionada",
