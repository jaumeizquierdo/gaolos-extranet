$(document.body).on('change', '.obtener-plantilla-mail', function () {

    event.preventDefault(event);

    Pace.restart();

    var ID_TM2 = document.getElementById('Plan').value;
    if (ID_TM2 === "0") {
        document.getElementById("MailTexto").value = "";
        return true;
    }
    ...
    Pace.track(function () {
        $.ajax(
            {
                type: "POST",
                url: "/modulo-facturacion/obtener-plantilla-mail",
                data: { ID_TM2: ID_TM2 },
                ...
                success: function (response, textStatus, jqXHR) {
                    if (response.err.eserror) {
                        ...
                        document.getElementById("MailTexto").value = response.datoS;
                        return true;
                    }
                },
...
$(document.body).on('click', '.facturacion-enviar-mail-factura', function () {
    ...
    Pace.track(function () {
        $.ajax(
            {
                type: "POST",
                url: "/modulo-facturacion/facturacionfacturaenviarpormail",
                data: { ID_Fac: idd },
                contentType: "application/x-www-form-urlencoded; charset=UTF-8",
                cache: false,
                datatype: "json",
...
$(document.body).on('click', '.facturacion-enviar-mail-factura-personalizado', function () {

    event.preventDefault(event);

    Pace.restart();

    var idd = "env_" + document.getElementById("ID_Fac").value + "_no";
    var MailAsunto = document.getElementById("MailAsunto").value;
    var MailTexto = document.getElementById("MailTexto").value;

    if (MailAsunto === "") {
        $.jGrowl("Debe indicar un asunto", $optionsMessageKO);
        return;
    }

    if (MailTexto === "") {
        $.jGrowl("Debe indicar un text para el cuerpo del mail", $optionsMessageKO);
        return;
    }
        ...
        $.ajax(
            {
                type: "POST",
                url: "/modulo-facturacion/facturacionfacturaenviarpormail",
                data: { ID_Fac: idd, MailAsunto: MailAsunto, MailTexto: MailTexto },
                contentType: "application/x-www-form-urlencoded; charset=UTF-8",
                cache: false,
                datatype: "json",
                success: function (response, textStatus, jqXHR) {
...
$(document.body).on('click', '.facturacion-eliminar-factura', function () {
    ...
    Pace.track(function () {
        $.ajax(
            {
                type: "POST",
                url: "/modulo-facturacion/facturacionfacturaeliminar",
                data: { ID_Fac: ID_Fac, ObsEli: ObsEli },
                contentType: "application/x-www-form-urlencoded; charset=UTF-8",
                cache: false,
                datatype: "json",
                success: function (response, textStatus, jqXHR) {
                    if (response.err.eserror) {
                        ...
                        $.jGrowl(response.err.mensaje, $optionsMessageOK);
                        window.open("/modulo-facturacion/facturas", "_self");
                        return true;
                    }
                },
                error: function (jqXHR, textStatus, errorThrown) {
...
$(document.body).on('click', '.facturacion-cambiar-obs-factura', function () {
    ...
    var ID_Fac = document.getElementById('ID_Fac').value;
    var Obs = document.getElementById('ObsFacGua').value;

    Pace.track(function () {
        $.ajax(
            {
                type: "POST",
                url: "/modulo-facturacion/facturacionfacturacambiarobservaciones",
                data: { ID_Fac: ID_Fac, Obs: Obs },
                contentType: "application/x-www-form-urlencoded; charset=UTF-8",
                cache: false,
                datatype: "json",
                success: function (response, textStatus, jqXHR) {
...
$(document.body).on('click', '.facturacion-nueva-solicitud', function () {
    ...
    var Fe_In = document.getElementById('Fe_In').value + " " + document.getElementById('Ho_In').value;

    Pace.track(function () {
        $.ajax(
            {
                type: "POST",
                url: "/modulo-facturacion/facturacionnuevasolicitud",
                data: { ID_Fac: ID_Fac, Expo: Expo, ID_Us_Asi: ID_Us_Asi, Fe_In: Fe_In },
                contentType: "application/x-www-form-urlencoded; charset=UTF-8",
                cache: false,
                datatype: "json",
                success: function (response, textStatus, jqXHR) {
...
$(document.body).on('click', '.sel-fac', function () {
...
function DatosFactura(ID_Fac) {

    Pace.track(function () {
        $.ajax(
            {
                type: "GET",
                url: "/modulo-facturacion/informacion-factura",
                data: { ID_Fac: ID_Fac },
                contentType: "application/x-www-form-urlencoded; charset=UTF-8",
                cache: false,
                datatype: "json",
