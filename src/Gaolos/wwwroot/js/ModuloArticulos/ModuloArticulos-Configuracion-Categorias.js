$(document.body).on('click', '.eliminar-categoria-art', function () {
    ...
    Pace.track(function () {
        $.ajax({
            type: "GET",
            url: "/modulo-articulos/configuracion/categorias/categoria/eliminar",
            ...
            success: function (response, textStatus, jqXHR) {
                if (response.err.eserror) {
                    ...
                    window.open("/modulo-articulos/configuracion/categorias", "_self");
                    return;
                }
            },
...
$(document.body).on('click', '.nueva-categoria-art', function () {
    ...
    Pace.track(function () {
        $.ajax({
            type: "GET",
            url: "/modulo-articulos/configuracion/categorias/categoria/nueva",
            data: { Cat: Cat },
            contentType: "application/json;charset=utf-8",
            cache: false,
            datatype: "json",
...
$(document.body).on('click', '.guardar-categoria-art', function () {
...
$(document.body).on('click', '.ver-categoria-art', function () {
    ...
    Pace.track(function () {
        $.ajax({
            type: "GET",
            url: "/modulo-articulos/configuracion/categorias/categoria",
            data: { ID_Cat2: ID_Cat2 },
            contentType: "application/json;charset=utf-8",
            cache: false,
            datatype: "json",
