$(document.body).on('click', '.eliminar-familia-serv', function () {
    ...
    Pace.track(function () {
        $.ajax({
            type: "GET",
            url: "/modulo-servicios/configuracion/familias/familia/eliminar",
            ...
            success: function (response, textStatus, jqXHR) {
                if (response.err.eserror) {
                    ...
                    window.open("/modulo-servicios/configuracion/familias", "_self");
                    return;
                }
            },
...
$(document.body).on('click', '.nueva-familia-serv', function () {
    ...
    Pace.track(function () {
        $.ajax({
            type: "GET",
            url: "/modulo-servicios/configuracion/familias/familia/nueva",
            data: { Fam: Fam },
            contentType: "application/json;charset=utf-8",
            cache: false,
            datatype: "json",
...
$(document.body).on('click', '.guardar-familia-serv', function () {
    ...
    Pace.track(function () {
        $.ajax({
            type: "GET",
            url: "/modulo-servicios/configuracion/familias/familia/guardar",
...
$(document.body).on('click', '.ver-familia-serv', function () {
    ...
    Pace.track(function () {
        $.ajax({
            type: "GET",
            url: "/modulo-servicios/configuracion/familias/familia",
            data: { ID_Fam2: ID_Fam2 },
            contentType: "application/json;charset=utf-8",
            cache: false,
            datatype: "json",
